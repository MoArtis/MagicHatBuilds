...
summary: "The title says it all.<br>I feel that the overstock malus (big speed decrease
    ...
    attacks (including bullet types).<br>I also really need to have a look at the resistances
    / weaknesses system. It's one of the main pillars of the game after all: Strategically absorb
    ...
    of game is usually to destroy first smaller enemies that add chaos to the more predictable
    patterns generated by the bigger enemies. I feel the rooms should be designed around
